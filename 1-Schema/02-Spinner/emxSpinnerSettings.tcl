...
#                                   WARNING: Attribute must be deleted then added to change type so may cause loss of data
   ...
   set bSpinnerRollBack "FALSE"      ;# TRUE or FALSE - Spinner objects backup will be take before modified/deleted, backup of object will not be taken
   set bUnifiedTyping "TRUE"       ;#TRUE or FALSE - Do not import Type, Interface, Relationship governed by Unified Typing rule/ Import Type, Interface, Relationship governed by Unified Typing rule
   set sUnifiedTypingExceptionalType "Change Action|Issue|Part|Proposed Activity|googMSOP|googCPK|Company" ;#Type are delimited by pipe(|),Import Type irrespective of it is governed by Unified Typing rule
   set sUnifiedTypingExceptionalInterface "" ; #Interface are delimited by pipe(|),Import Interface irrespective of it is governed by Unified Typing rule
   set sUnifiedTypingExceptionalRelationship "EBOM" ;#Relationship are delimited by pipe(|),Import Relationship irrespective of it is governed by Unified Typing rule
   set sGlobalConfigType ""  
   set sTransactionMode "RollbackCurrent"      ;# RollbackEverything or RollbackSchemaType or RollbackCurrent use only one of this transaction mode for commiting data into database default RollbackEverything
   set bSpinnerDebug "FALSE"      ;# TRUE or FALSE - Spinner Debug Logs generation
#  ****************************************************************************
